...
class _ResolverOpMeta(abc.ABCMeta):
  ...
  def __init__(
      ...
      arguments: Sequence[DataTypes] = (DataTypes.ARTIFACT_MULTIMAP,),
      returns: DataTypes = DataTypes.ARTIFACT_MULTIMAP):
    cls._props_by_name = {
        prop.name: prop
    ...
    if len(arguments) != 1:
      raise NotImplementedError('len(arguments) should be 1.')
    cls._arg_data_type = arguments[0]
    cls._return_data_type = returns
